                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    ...
                                    <p class="mb-0">
                                        <small>@lang('If you enable this module, users can earn referral bonus.') @lang('Set referral commission from the') <a href="{{ route('admin.referrals.index') }}">@lang('Referral Setting')</a>.</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" name="referral" @if ($general->referral) checked @endif>
                                </div>
                            </li>
